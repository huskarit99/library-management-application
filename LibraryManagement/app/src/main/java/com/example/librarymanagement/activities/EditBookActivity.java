...
public class EditBookActivity extends AppCompatActivity {
    ...
    private TextView edtBookName, edtPublishingYear, edtAuthor, edtCategory, edtPublisher, edtBookId, edtQuantum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Chỉnh sửa sách");
        ...
        edtBookId.setInputType(InputType.TYPE_NULL);
    ...
    void init(){
        ...
        path.replace("p:", "ps:");
        Picasso.get().load(path).into(edtImage);
        edtBookName.setText(book.getName());
        edtBookId.setText(valueOf(book.getBook_id()));
        edtCategory.setText(book.getCategory());
        edtAuthor.setText(book.getAuthors());
        edtPublisher.setText(book.getPublisher());
        edtPublishingYear.setText(valueOf(book.getPublicationYear()));
        edtQuantum.setText(valueOf(book.getAmount()));
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.save_data) {
            ...
            if (book_name == "" || publishing_year == "" || image == "" || publisher == "" || category == "" || selectedAuthors.length() == 0) {
                Toast.makeText(EditBookActivity.this, "Bạn đã cung cấp thiếu thông tin !!!", Toast.LENGTH_SHORT).show();
            }
            else{
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.ADDBOOK,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                Toast.makeText(EditBookActivity.this, "Cập nhật dữ liệu thành công", Toast.LENGTH_SHORT).show();
//                                finish();
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(EditBookActivity.this, "Cập nhật dữ liệu thất bại", Toast.LENGTH_SHORT).show();
                            }
                        }) {
                    @Override
    ...
    public void getAuthors(){
        ...
        JsonArrayRequest arrayReq = new JsonArrayRequest(Request.Method.GET, Server.GETALLAUTHORS, null,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditBookActivity.this, "Lỗi", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void mapping() {
        ...
        edtQuantum = findViewById(R.id.edtQuantum);
    }
}
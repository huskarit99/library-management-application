...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, InformationPersonActivity.class);
                startActivity(intent);
            }
        });
        linearReaderManager.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("LIBRARIAN MANAGER", "reader manager");
                startActivity(intent);
            }
        });
        linearLibrarianManager.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, UserManagerActivity.class);
                intent.putExtra("LIBRARIAN MANAGER", "librarian manager");
                startActivity(intent);
            }
        });
    ...
    private void getListBorrowedBook() {
        ...
        final String url = Server.GETBORROWEDBOOK + "?id=" + valueOf(user_id);
        Thread thread = new Thread(new Runnable() {
            @Override
            public void run() {
